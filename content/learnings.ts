  ...
  items: [
    {
      ...
      reflection:
        ...
        body: ["Having heard the hype and prowess of AI-assisted development, I knew I had to start somewhere - and this is just the beginning.",
              "My skills as an engineer hovers around backend development, data pipelines and visualization. Eventhough I had fiddle around with UI development before, this area still remains unfamiliar to me. So, I thought that this would be a good playground for me to understand what AI-assisted development could achieve.",
              "By building this portfolio with the help of AI, I was able to build something shippable within a day. Nonetheless, at the end of the day, without human, AI will ship generic and replicable products. This made me realise that how I steered the conversations by adding my preferences and vision makes this page uniquely mine."]
    },
    {
      ...
      body: ["CKAD was the first certificate that I had studied for after entering the workforce. Since I was actively deploying applications on Kubernetes, I thought - why not?",
          "While I was working with Kubernetes on a daily basis, I faced challenges in understanding how to optmize a deployment configuration to reduce cost, but still ensure the application is stable. Even thought I had knowledge in Docker and containerization, it wasn't sufficient for me to confidently make changes or debug the deployment configuration.",
              "Through my studies for CKAD, I was able to get hands-on familiarity with the framework and understand how and why I should or shouldn't amend a certain configuration Additionally, it changed how I was debugging the applicaiton: less trial-and-error, more reasoning and targeted investigations."],
    },
