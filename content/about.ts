...
export const about = {
  ...
  paragraphs: [
    ...
    "I work mostly in Java, with solid platform foundations across Kubernetes (CKAD), Terraform, and AWS, plus hands-on proficiency in **Claude** and AI-assisted development. I love to understand challenging problems, breaking them down into bite-sized pieces for solutioning, and I care about building things that are reliable, not just clever.",
  ],
  currently: {
    title: "Currently",
    items: [
